class WeatherManager {
  ...
  // No periodic updates; fetch only once at program start

  // State
  String condition = "sunny"; // sunny, partly_cloudy, rain, snow, fog, thunderstorm, unknown
  float temperature = 20.0;
  float cloudCover = 0.0; // 0..1
